...
BEGIN
    LET rs RESULTSET := (
        SELECT column1 as p1, column2 as p2, column3 as p3 
        FROM VALUES 
    ...
    FOR row_variable IN rs DO
        LET p1_val STRING := row_variable.p1;
        LET p2_val STRING := row_variable.p2;
        LET p3_val STRING := row_variable.p3;
        
        CALL test_2(:p1_val, :p2_val, :p3_val);
    END FOR;
